    ...
    <div className="space-y-6  text-[#163143] font-[400] mt-6">
      <div>
        ...
        <NotesInput
          ...
          borderColor={additionalFeedback?.length < 70 ? "#FF5546" : "#D7E6E7"}
          notes={additionalFeedback}
          onChange={(e) => onUpdate({ additionalFeedback: e })}
        />
        {/* <textarea
      ...
      <div>
        ...
        <NotesInput
          id="improvements"
          placeholder="Add notes here..."
          borderColor={improvements?.length < 70 ? "#FF5546" : "#D7E6E7"}
          notes={improvements}
          onChange={(e) => onUpdate({ improvements: e })}
        />
        {/* <textarea
          value={improvements}
      ...
      <div>
        ...
        <NotesInput
          id="recommendations"
          placeholder="Add notes here..."
          borderColor={recommendations?.length < 70 ? "#FF5546" : "#D7E6E7"}
          notes={recommendations}
          onChange={(e) => onUpdate({ recommendations: e })}
        />
        {/* <textarea
