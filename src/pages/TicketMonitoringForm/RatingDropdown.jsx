      ...
      <div className="flex items-start gap-4">
        <div className="relative">
          <button
            ...
            className={`w-20 px-3 py-2 text-left bg-white border-2 rounded-lg shadow-sm focus:outline-none focus:ring-2 flex items-center justify-between transition-colors ${
              isIncluded
                ? isOpen
          ...
          {isOpen && isIncluded && (
            <div className="absolute z-10 w-20 mt-1 bg-white border border-gray-300 rounded-lg shadow-lg">
              <div className="py-1">
                {options.map((option) => (
                  <button
                    key={option.value}
